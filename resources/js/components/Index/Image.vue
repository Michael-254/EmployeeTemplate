              ...
              <div v-if="showForm">
                <div class="mt-2">
                  <p class="text-xs text-gray-500">
                    ...
                    department. i.e National ID, Bank Account NSSF and NHIF. If
                    you are not sure kindly contact the HR department for more
                    information
                  </p>
                </div>
                          ...
                          <td>
                            <div class="border rounded-md shadow-md p-2 mr-2">
                              <button
                                ...
                                class="items-center px-3 py-2 bg-red-500 border rounded-md text-xs text-white hover:bg-red-800 focus:outline-none focus:ring ring-gray-300 transition ease-in-out duration-150"
                              >
                                Delete
                              </button>
                            </div>
